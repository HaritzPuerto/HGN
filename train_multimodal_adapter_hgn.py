...
from transformers import get_linear_schedule_with_warmup, MultiModalAdapterRoberta, AdamW
...
run = neptune.init(tags=["HGN", "MultiModal", "Vanilla Adapter"])
...
model = MultiModalAdapterRoberta(args)
