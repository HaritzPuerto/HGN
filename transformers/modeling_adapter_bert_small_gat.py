...
class BertLayer(nn.Module):
    def __init__(self, config):
        ...
        self.adapter_graph_bottom = TextAdapter(config_adapters)
        self.adapter_text_bottom = TextAdapter(config_adapters)

        self.adapter_text_top = TextAdapter(config_adapters)
        self.adapter_graph_top = StructAdapter(config_adapters)
...
class BertEncoder(nn.Module):
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            (layer_outputs, graph_output) = layer_module(
        ...
        return (outputs, graph_output)  # last-layer hidden state, (all hidden states), (all attentions)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs, graph_output = self.encoder(
            embedding_output,
        ...
        return outputs, graph_output  # sequence_output, pooled_output, (hidden_states), (attentions)
