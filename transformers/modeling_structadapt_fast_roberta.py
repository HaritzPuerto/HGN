...
from .modeling_structadapt_fast_bert import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class StructAdaptFastRoberta(nn.Module):
    def __init__(self, config):
        super(StructAdaptFastRoberta, self).__init__()     
