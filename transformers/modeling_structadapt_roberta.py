...
from .modeling_structadapt_bert import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class StructAdaptRoberta(nn.Module):
    def __init__(self, config):
        super(StructAdaptRoberta, self).__init__()     
        # Transformer Encoder
