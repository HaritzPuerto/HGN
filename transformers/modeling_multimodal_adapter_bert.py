...
class BertLayer(nn.Module):
    def __init__(self, config):
        ...
        self.adapter_graph_top = Adapter(config_adapters)
    ...
    def forward(
        ...
        # skip connections
        outputs_text = (layer_output_text,) + outputs
        outputs_graph = (layer_output_graph,) + outputs
        return outputs_text, outputs_graph
...
class BertEncoder(nn.Module):
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            layer_outputs, layer_outputs_graph = layer_module(
        ...
        return outputs, layer_outputs_graph  # last-layer hidden state, (all hidden states), (all attentions)
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs, encoder_outputs_graph = self.encoder(
            embedding_output,
        ...
        return (outputs, encoder_outputs_graph)  # sequence_output, pooled_output, (hidden_states), (attentions)
