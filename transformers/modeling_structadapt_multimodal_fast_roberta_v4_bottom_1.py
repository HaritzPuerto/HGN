...
from .modeling_structadapt_multimodal_fast_bert_v4_bottom_1 import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptFastRoberta_v4_bottom_1(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptFastRoberta_v4_bottom_1, self).__init__()     
