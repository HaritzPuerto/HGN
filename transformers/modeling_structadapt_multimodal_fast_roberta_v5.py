...
from .modeling_structadapt_multimodal_fast_bert_v5 import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalStructAdaptFastRoberta_v5(nn.Module):
    def __init__(self, config):
        super(MultiModalStructAdaptFastRoberta_v5, self).__init__()     
    ...
    def forward(
            ...
            text_outputs, graph_outputs, graph_dict = self.encoder(
            ...
            return self.pred_layer(batch, text_outputs[0], graph_dict, packing_mask=query_mapping, return_yp=return_yp)
