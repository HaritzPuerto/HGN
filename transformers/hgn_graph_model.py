...
class GraphBlock(nn.Module):
    '''
    This is the implementation of the graph block in the paper. I think it may not work well with n_layes > 1.
    '''
    ...
    def forward(self, batch, input_state, query_vec):
        ...
        #         'sent_state': sent_state,
        #         'query_vec': query_vec,
        #         'para_logit': para_logit,
        #         'para_prediction': para_prediction,
