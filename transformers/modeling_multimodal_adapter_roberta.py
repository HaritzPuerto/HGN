...
from .modeling_multimodal_adapter_bert import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu
...
class MultiModalAdapterRoberta(nn.Module):
    def __init__(self, config):
    ...
    def forward(
            ...
            (encoder_outputs_text, encoder_outputs_graph) = self.encoder(
