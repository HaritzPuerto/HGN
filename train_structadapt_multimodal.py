...
from transformers import get_linear_schedule_with_warmup, MultiModalStructAdaptRoberta, AdamW
...
run = neptune.init(tags=["StructAdapt-Heavy", "MultiModal"])
...
model = MultiModalStructAdaptRoberta(args)
