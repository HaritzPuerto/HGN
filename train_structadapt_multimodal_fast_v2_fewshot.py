...
run = neptune.init(tags=[few_shot_tag, "StructAdapt-fast", "MultiModal", "LSTM", "base"])
...
logger.info(f"Dev dataset size: {len(dev_dataloader)}")
...
for epoch in train_iterator:
    ...
    logger.info(f"Evaluating on dev set in epoch {epoch}")
